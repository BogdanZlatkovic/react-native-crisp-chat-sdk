...
export declare enum CrispSessionEventColors {
    RED = 0,
    ORANGE = 1,
    YELLOW = 2,
    GREEN = 3,
...
export interface Spec extends TurboModule {
    ...
    searchHelpdesk(): void;
    openHelpdeskArticle(id: string, locale: string, title: string | null, category: string | null): void;
    runBotScenario(scenarioId: string): void;
    registerPushToken(token: string): void;
}
declare const _default: Spec;
export default _default;
//# sourceMappingURL=NativeCrispModule.d.ts.map